    ...
    <>
      ...
      <ScrollView style={{ flex: 1, }}>
        ...
        <View style={styles.container}>
          <Text style={styles.header}>Topup Airtime</Text>
            ...
            return (
              <View key={i}>
                <FlexCard
                  ...
                  leftIcon={obj.type == 'Select Number' ? (selectedProduct ? <AntDesign name="checkcircle" size={30} color='#008000' /> : renderLeftIcon(id)) : obj.type == 'Select Bundle Size' ? (selectedBundle ? <AntDesign name="checkcircle" size={30} color='#008000' /> : renderLeftIcon(id)) : obj.type == 'Select Payment Method' ? selectedPaymentMethod ? <AntDesign name="checkcircle" size={30} color='#008000' /> : renderLeftIcon(obj.id) : renderLeftIcon(id)}
                  text={obj.type == 'Select Number' ? selectedProduct ? selectedProduct : obj.type : obj.type == 'Select Bundle Size' ? selectedBundle ? `${selectedBundle.bundleName} mins.` : obj.type : obj.type == 'Select Payment Method' ? selectedPaymentMethod ? selectedPaymentMethod : obj.type : obj.type}
